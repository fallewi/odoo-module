    ...
    def cancel_in_woo(self):
        ...
        if errors:
            ...
            transaction_log_obj.create(
                                        {'message':"Error - cancel order in woo,  %s"%(message),
...
#             'picking_id':picking.id
        ...
        vals = ({'invoice_line_tax_id':[(6,0,tax_ids)],'invoice_id':invoice.id,'product_id':False,'price_unit':price_unit,'quantity':qty,'name':self.inv_line_des,'account_id':account_id})
